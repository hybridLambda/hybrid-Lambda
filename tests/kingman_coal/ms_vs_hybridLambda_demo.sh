...
CURRENTCASE=case1_${net}
echo -e ${CURRENTCASE} > current_case
rm -rf ms* hybridLambda*
#ms 5 ${rep} -T -t 10 -I 5 1 1 1 1 1 -ej .5 4 3 -ej 0.8 2 3 -es 1.1 3 1.0 -ej 1.4 6 5 -es 1.4 3 1.0 -ej 1.7 7 5 -ej 1.7 3 1 -ej 2 5 1 -t 10 > msout
#grep ";" msout > ms_gt
cat msout | sample_stats > ms_stats
ms 5 ${rep} -T -t 10 -I 5 1 1 1 1 1 -ej .5 4 3 -ej 0.8 2 3 -ej 1.7 3 1 -ej 2 5 1 -t 10 > msout
grep ";" msout > ms_gt
cat msout | sample_stats > ms_stats
hybrid-Lambda -gt ms_gt -o ms -tmrca -bl
...
CURRENTCASE=case2_${net}
echo -e ${CURRENTCASE} > current_case
rm -rf ms* hybridLambda*
ms 5 ${rep} -T -t 10 -I 5 1 1 1 1 1 -ej .5 4 3 -ej 0.8 2 3 -es 1.1 3 0.8 -ej 1.4 6 5 -es 1.4 3 0.8 -ej 1.7 7 5 -ej 1.7 3 1 -ej 2 5 1 -t 10 > msout
grep ";" msout > ms_gt
cat msout | sample_stats > ms_stats
hybrid-Lambda -gt ms_gt -o ms -tmrca -bl
hybrid-Lambda -spcu ../../../trees/${net} -num ${rep} -o hybridLambda -tmrca -bl -mu 0.0005 -seg -sim_Si_num
...
CURRENTCASE=case3_${net}
echo -e ${CURRENTCASE} > current_case
rm -rf ms* hybridLambda*
ms 5 ${rep} -T -t 10 -I 5 1 1 1 1 1 -ej .5 4 3 -ej 0.8 2 3 -es 1.1 3 0.5 -ej 1.4 6 5 -es 1.4 3 0.5 -ej 1.7 7 5 -ej 1.7 3 1 -ej 2 5 1 -t 10 > msout
grep ";" msout > ms_gt
cat msout | sample_stats > ms_stats
hybrid-Lambda -gt ms_gt -o ms -tmrca -bl
hybrid-Lambda -spcu ../../../trees/${net} -num ${rep} -o hybridLambda -tmrca -bl -mu 0.0005 -seg -sim_Si_num
...
CURRENTCASE=case4_${net}
echo -e ${CURRENTCASE} > current_case
rm -rf ms* hybridLambda*
ms 5 ${rep} -T -t 10 -I 5 1 1 1 1 1 -ej .5 4 3 -ej 0.8 2 3 -es 1.1 3 0.2 -ej 1.4 6 5 -es 1.4 3 0.2 -ej 1.7 7 5 -ej 1.7 3 1 -ej 2 5 1 -t 10 > msout
grep ";" msout > ms_gt
cat msout | sample_stats > ms_stats
hybrid-Lambda -gt ms_gt -o ms -tmrca -bl
hybrid-Lambda -spcu ../../../trees/${net} -num ${rep} -o hybridLambda -tmrca -bl -mu 0.0005 -seg -sim_Si_num
...
CURRENTCASE=case6_${net}
echo -e ${CURRENTCASE} > current_case
rm -rf ms* hybridLambda*
ms 5 ${rep} -T -t 10 -I 5 1 1 1 1 1 -ej .5 4 3 -ej 50.5 2 3 -es 100.5 3 0.5 -ej 150.5 6 5 -es 150.5 3 0.5 -ej 200.5 7 5 -ej 200.5 3 1 -ej 250.5 5 1 -t 10 > msout
grep ";" msout > ms_gt
cat msout | sample_stats > ms_stats
hybrid-Lambda -gt ms_gt -o ms -tmrca -bl
hybrid-Lambda -spcu ../../../trees/${net} -num ${rep} -o hybridLambda -tmrca -bl -mu 0.0005 -seg -sim_Si_num
