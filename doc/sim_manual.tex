...
\cm{\mbox{hybrid-Lambda -spcu '((1:1,2:1):1,3:2);'\  -num 3 -seed 2 -gF example1} -log}
...
\cm{ \mbox{ hybrid-Lambda -spcu trees/4\_tax\_sp\_nt1\_para -gF example2 -num 2 \textbackslash } \mbox{-mu 0.00003 -sim\_mut\_unit -sim\_num\_mut }}
